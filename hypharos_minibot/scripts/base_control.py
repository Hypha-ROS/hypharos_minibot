...
import struct
# from package import imu_gy85
from package.imu_gy85 import GY85
...
class BaseControl:
    def __init__(self):
        ...
        self.imu_topic = rospy.get_param('~imu_topic', '/imu_data') # topic name
        self.pub_tf = bool(rospy.get_param('~pub_tf', True)) # whether publishes TF or not
        # self.pub_imu = bool(rospy.get_param('~pub_imu', True))
        ...
        self.imu = GY85(self.imu_link,self.imu_topic)
    ...
    def timerOdomCB(self, event):
        ...
        try:       
            ...
            print 'odom_yaw_pose= ', self.pose_yaw*57
            ...
            self.imu.get_imuData(gyro_z*9) # 9 for nonsense
